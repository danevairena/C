...
void rotate_text(string txt, int key);
...
char rotate(char letter, int key)
{
    //check if char is alphabetical letter to change it
    char ciletter;
    ciletter = letter + key;
